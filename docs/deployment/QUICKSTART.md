...
1. 🧪 **[Локальное тестирование](../ru/LOCAL_TESTING.md)** - Подробное руководство по тестированию проекта
2. 📖 Прочитайте [ДОКУМЕНТАЦИЯ.md](./ДОКУМЕНТАЦИЯ.md) для полной документации
3. 👥 Изучите [USER_GUIDE.md](./USER_GUIDE.md) для руководства пользователя
4. 🤝 Прочитайте [CONTRIBUTING.md](./CONTRIBUTING.md) если хотите участвовать в разработке
5. 🚀 Изучите [DEPLOYMENT.md](./DEPLOYMENT.md) для развертывания в продакшн
6. 🔒 Ознакомьтесь с [SECURITY.md](./SECURITY.md) для рекомендаций по безопасности
