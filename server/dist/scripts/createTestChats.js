...
async function createTestChats() {
    try {
        ...
        for (const chatConfig of testChats) {
            const participants = users.filter(u => chatConfig.participantUsernames.includes(u.username));
...
exports.default = createTestChats;
//# sourceMappingURL=createTestChats.js.map